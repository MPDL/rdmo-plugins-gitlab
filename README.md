...
PROJECT_ISSUE_PROVIDERS += [
    ('gitlab', _('GitLab Provider'), 'rdmo_gitlab.providers.issues.GitLabIssueProvider'),
]
```
...
Users can add a GitLab integration to their projects. They need to provide the URL to their repository. Afterward, project tasks can be pushed to the GitLab repository as repo issues.
